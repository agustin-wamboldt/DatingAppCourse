...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        [HttpPost] // Verify if needed anymore after SignalR implementation
        public async Task<ActionResult<MessageDTO>> CreateMessage(CreateMessageDTO createMessageDTO)
        {
            ...
            if (await _unitOfWork.Complete()) return Ok(_mapper.Map<MessageDTO>(message)); // Should return a Created at Route
