...
export class MembersService {
  ...
  getLikes(predicate: string, pageNumber: number, pageSize: number) { // Another way to do it compared to getMembers. getMembers is "the best" since it implements a class for this though.
